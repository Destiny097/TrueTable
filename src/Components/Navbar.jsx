...
import '../index.css'
import logo from '../assets/Gemini_Generated_Image_4856pd4856pd4856-removebg-preview.png'
  ...
  return (
    <div className='bg-white/20 backdrop-blur-2xl h-[60px] w-[85vw] px-5 rounded-2xl flex items-center justify-between fixed top-2 left-1/2 -translate-x-1/2 z-50'>
      ...
      <div className='flex items-center'>
        <span className='px-3 py-1 rounded hover:bg-white/30 duration-200 cursor-pointer mr-2 hidden md:inline text-[16px] transition-all hover:text-[#0118D8] font-medium'>Login</span>
